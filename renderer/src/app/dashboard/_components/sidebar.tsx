...
export function Sidebar({ className }: SidebarProps) {
  ...
  const SidebarButton = ({ item }: { item: SidebarItem }) => (
    ...
    >
      <item.icon size={16} className="mr-3 text-zinc-600 dark:text-zinc-400 flex-shrink-0" />
        ...
        <div className="flex flex-col space-y-2 p-2 pt-4">
          <div className="space-y-1.5">
            ...
            <div className="relative px-1">
              <Search
                size={15}
                className="absolute left-3 top-1/2 -translate-y-1/2 transform text-zinc-400 pointer-events-none"
              />
              <Input
                placeholder="Search"
          ...
          <div className="-mx-2">
            <Separator className="my-2 bg-zinc-300/40 dark:bg-zinc-700/40" />
          </div>
